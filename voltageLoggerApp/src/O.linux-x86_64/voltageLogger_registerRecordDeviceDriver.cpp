...
/* Generated from ../O.Common/voltageLogger.dbd */
...
epicsShareExtern void (*pvar_func_register_func_initialize)(void);
epicsShareExtern void (*pvar_func_register_func_setPath)(void);
epicsShareExtern void (*pvar_func_register_func_getVoltage)(void);
...
int voltageLogger_registerRecordDeviceDriver(DBBASE *pbase)
{
    const char *bldTop = "/media/Extra_Space/work/voltageLoggerIOC";
    ...
    (*pvar_func_asSub)();
    (*pvar_func_register_func_initialize)();
    (*pvar_func_register_func_setPath)();
    (*pvar_func_register_func_getVoltage)();
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"voltageLogger_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
static void registerRecordDeviceDriverCallFunc(const iocshArgBuf *)
{
    voltageLogger_registerRecordDeviceDriver(*iocshPpdbbase);
}
